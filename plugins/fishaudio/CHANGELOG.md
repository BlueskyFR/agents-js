...
- Enable Fish Audio quality guard on every TTS request. - [#2237](https://github.com/livekit/agents-js/pull/2237) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
