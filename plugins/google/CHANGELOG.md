...
- Route Gemma 4 thinking configuration through `thinkingLevel` and validate supported levels. - [#2408](https://github.com/livekit/agents-js/pull/2408) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- Gemini realtime: keep unspoken model text parts out of the transcript when the session runs with audio output and output transcription enabled. - [#2294](https://github.com/livekit/agents-js/pull/2294) ([@anzemur](https://github.com/anzemur))
