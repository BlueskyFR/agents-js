...
- Ignore stale audio and completion frames from previous contexts on pooled WebSocket connections. - [#2401](https://github.com/livekit/agents-js/pull/2401) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- Redact API keys and URL credentials from Cartesia WebSocket handshake errors. - [#2248](https://github.com/livekit/agents-js/pull/2248) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
