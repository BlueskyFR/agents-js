...
- Add numerals, profanity filtering, and number redaction options to Deepgram Flux STT. - [#2377](https://github.com/livekit/agents-js/pull/2377) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- Use Deepgram's punctuated word values in word-level transcripts when formatting is enabled. - [#2227](https://github.com/livekit/agents-js/pull/2227) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
