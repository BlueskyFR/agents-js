...
- Avoid forwarding repeated partial transcripts from ElevenLabs Scribe realtime STT. - [#2380](https://github.com/livekit/agents-js/pull/2380) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))

- Add secondary language hints for ElevenLabs Scribe v2 realtime STT. - [#2406](https://github.com/livekit/agents-js/pull/2406) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- Send keyterms when connecting to the ElevenLabs realtime STT WebSocket - [#2283](https://github.com/livekit/agents-js/pull/2283) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
